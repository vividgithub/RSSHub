...
app.use(mount('/rsshub', router.routes())).use(router.allowedMethods());

// routes the require authentication
app.use(mount('/rsshub/protected', protected_router.routes())).use(protected_router.allowedMethods());

// API router
app.use(mount('/rsshub/api', api_router.routes())).use(api_router.allowedMethods());
