...
// vivi
router.get('/vivi/disneyanimation', require('./routes/vivi/disneyanimation'));
router.get('/vivi/entagma', require('./routes/vivi/entagma'));
router.get('/vivi/generic/:data', require('./routes/vivi/generic'));
